...
function QuoteBox({ likedQuotes, setLikedQuotes }) {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-5 sm:p-12 border border-purple-100 dark:border-gray-700 transition-all duration-300">
        {loading ? (
            ...
            <div className="text-center py-6 sm:py-8">
                ...
                <p className="text-xl sm:text-3xl font-serif text-gray-800 dark:text-gray-100 leading-relaxed mb-5 sm:mb-6 italic">
                    "{quote}"
                </p>
