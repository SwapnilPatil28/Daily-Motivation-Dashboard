...
function LikeCountFooter({ likedCount }) {
  return (
    <footer className="bg-white/50 dark:bg-gray-900/50 backdrop-blur-lg border-t border-purple-200 dark:border-gray-700 mt-12 sm:mt-20 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 py-6 text-center">
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          ...
          <p className="text-base sm:text-lg font-semibold text-gray-700 dark:text-gray-300">
            ...
            Total Liked Quotes: 
            <span className="ml-2 text-xl sm:text-2xl bg-gradient-to-r from-purple-600 to-pink-600 dark:from-purple-400 dark:to-pink-400 bg-clip-text text-transparent">
              {likedCount}
            </span>
          </p>
        </div>
